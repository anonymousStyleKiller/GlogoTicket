...
{
    public class GetPageOrdersForMonthQueryHandler : IRequestHandler<GetPageOrdersForMonthQuery, PageOrdersForMonthVm>
    {
        private readonly IOrderRepository _orderRepository;
        private readonly IMapper _mapper;

        public GetPageOrdersForMonthQueryHandler(IOrderRepository orderRepository, IMapper mapper)
        {
        ...
        public async Task<PageOrdersForMonthVm> Handle(GetPageOrdersForMonthQuery request,
            CancellationToken cancellationToken)
        {
            ...
            return new PageOrdersForMonthVm
